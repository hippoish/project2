...
ActiveRecord::Schema.define(version: 20160728205734) do
  ...
  add_index "carpools", ["neighborhood_id"], name: "index_carpools_on_neighborhood_id", using: :btree
  ...
  add_foreign_key "carpools", "neighborhoods"
